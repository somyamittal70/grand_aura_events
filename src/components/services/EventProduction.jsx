...
<<<<<<< HEAD
=======
import img1 from "../../assets/production.jpeg";
...
export default function EventProduction() {
  ...
  return (
    <>
      <section className="relative h-[280px] sm:h-[350px] md:h-[450px] lg:h-[500px] flex items-center justify-center overflow-hidden">
        {/* Background Image */}
        <img
<<<<<<< HEAD
          src={img}
...
>>>>>>> fe4c9d8 (Updated project)
    ...
    "
      ...
      "
        ...
        "
            >
              ...
              , we believe event production is more than just setting the stage
              – it’s about creating an atmosphere that captivates your audience
              from the moment they walk in. Whether it’s a grand wedding, a
              product launch, or a themed party, we design stunning environments
              using advanced lighting, sound, visuals, and décor to match your
              vision perfectly.
            </motion.p>
      ...
      <section className="bg-[#0B1D3A] py-14 sm:py-16 md:py-20 px-4 sm:px-6 md:px-10 pb-10">
        {/* Heading */}
        <div className="text-center mb-10 sm:mb-12 md:mb-14">
          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white">
            Event{" "}
            <span className="gold-shimmer-text font-medium">Production</span>
          </h2>

          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 mt-2 sm:mt-3">
            Delivering seamless production with creativity, precision &
            innovation
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto overflow-hidden">
          <div
            ...
            style={{
              transform: `translateX(-${currentIndex * 100}%)`, // 🔥 important change
            }}
          >
            {[
              {
                ...
                desc: "Custom stage setups designed to match your event’s theme and scale.",
              },
              {
                image: s2,
                title: "Lighting Solutions",
                desc: "Creative lighting designs that enhance ambiance and visual impact.",
              },
              {
                image: s3,
                title: "Sound Engineering",
                desc: "Professional audio systems ensuring crystal-clear sound delivery.",
              },
              {
                image: s4,
                title: "LED & Visual Displays",
                desc: "High-quality LED screens and visuals for immersive experiences.",
              },
              {
                image: s5,
                title: "Set Design & Fabrication",
                desc: "Innovative set designs crafted to bring concepts to life.",
              },
              {
                image: s6,
                title: "Live Event Production",
                desc: "End-to-end production management for flawless event execution.",
              },
              {
                image: s7,
                title: "Technical Direction",
                desc: "Expert coordination of all technical elements for smooth operations.",
              },
              {
                image: s8,
                title: "On-site Execution",
                desc: "Dedicated team ensuring everything runs perfectly on event day.",
              },
            ].map((item, i) => (
              <div
                key={i}
          ...
          "
              >
                <div className="relative rounded-xl overflow-hidden shadow-xl group">
                  ...
                  <img
                    ...
                    className="
                w-full 
                h-[220px] sm:h-[260px] md:h-[350px] lg:h-[450px] 
                object-cover 
              ...
              "
                  ...
                  <div
                    className="
              absolute bottom-4 sm:bottom-5 md:bottom-6 
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-10">
            {[
              ...
              {
                name: "Sneha Kapoor",
                text: "Absolutely wonderful experience! The team made our celebration unforgettable.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-10">
        {[
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
            className="
              bg-white/5 backdrop-blur-lg border border-[#CFAF4B33] 
              rounded-2xl sm:rounded-3xl 
              p-5 sm:p-6 md:p-10 
              shadow-[0_0_40px_rgba(0,0,0,0.5)]
              transition duration-300

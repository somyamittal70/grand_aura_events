...
>>>>>>> fe4c9d8 (Updated project)
        ...
        <motion.h1
          ...
          className="
      relative text-white font-bold text-center
      ...
      "
        ...
        "
            >
              ...
              , we believe recognition fuels motivation. That’s why we create
              tailored rewards and recognition events that shine a spotlight on
              achievements—big or small. Whether it’s an annual awards night or
              an appreciation day, we make every moment feel special.
            </motion.p>
      ...
      <section className="bg-[#0B1D3A] py-16 sm:py-20 px-4 sm:px-6 md:px-10 pb-10">
        ...
        <div className="text-center mb-10 sm:mb-14">
          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white">
            Rewards &{" "}
            <span className="gold-shimmer-text font-medium">Recognition</span>
          </h2>

          <p className="text-sm sm:text-base md:text-lg text-gray-300 mt-3">
            Celebrating achievements, excellence & memorable milestones
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Recognizing outstanding performance and dedication of employees.",
              },
              {
                image: s2,
                title: "Corporate Honors",
                desc: "Celebrating milestones and achievements within organizations.",
              },
              {
                image: s3,
                title: "Annual Recognition Events",
                desc: "Grand events to honor excellence and success every year.",
              },
              {
                image: s4,
                title: "Leadership Awards",
                desc: "Acknowledging visionary leaders and their impactful contributions.",
              },
              {
                image: s5,
                title: "Team Achievements",
                desc: "Celebrating teamwork and collective success across departments.",
              },
              {
                image: s6,
                title: "Appreciation Ceremonies",
                desc: "Special events to appreciate dedication and hard work.",
              },
              {
                image: s7,
                title: "Incentive Programs",
                desc: "Rewarding excellence through engaging and motivating programs.",
              },
              {
                image: s8,
                title: "Milestone Celebrations",
                desc: "Marking important achievements and memorable company moments.",
              },
            ].map((item, i) => (
              <div
                key={i}
            ...
            "
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xs sm:text-sm md:text-md text-gray-600 mt-2 group-hover:text-[#0B1D3A]">
                        {item.desc}
                      </p>
                    </div>
                  </div>
        ...
        <div className="flex justify-center sm:justify-end gap-3 sm:gap-4 mt-6">
          <button
            onClick={prevSlide}
            className="gold-shimmer-btn text-white px-5 sm:px-7 py-2 sm:py-3 rounded-full"
          >
            <ArrowLeft size={18} />
          </button>
      ...
      <section className="bg-[#071426] py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <motion.p
            ...
            className="text-gray-400 mb-6 sm:mb-8 md:mb-10 text-sm sm:text-base md:text-lg leading-6 sm:leading-7"
          >
        ...
        group 
        shadow-[0_0_20px_rgba(207,175,75,0.3)]
      "
          >
            {/* 🔥 SHIMMER BACKGROUND */}
...
function StatsContent() {
  ...
  return (
    <div
      ref={ref}
      className="max-w-6xl mx-auto relative z-10 text-center px-4 sm:px-0"
    >
      {/* Heading */}
      <motion.h2
        initial={{ opacity: 0, y: 60 }}

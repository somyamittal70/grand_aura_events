...
export default function TechIntegration() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentIndex((prev) => (prev < data.length - 3 ? prev + 1 : 0));
    }, 3000); // 3 sec
  ...
  const data = [
    {
      ...
      desc: "High-quality sound setups ensuring crystal-clear audio for every moment.",
    },
    {
      image: s2,
      title: "Lighting Design",
      desc: "Dynamic lighting solutions that enhance ambiance and create stunning visuals.",
    },
    {
      image: s3,
      title: "LED Walls & Screens",
      desc: "High-resolution LED displays for impactful presentations and live visuals.",
    },
    {
      image: s4,
      title: "Stage Setup",
      desc: "Professionally designed stages tailored to match your event theme.",
    },
    {
      image: s5,
      title: "Live Streaming",
      desc: "Seamless live streaming solutions to connect your event globally.",
    },
    {
      image: s6,
      title: "AV Production",
      desc: "Complete audio-visual production with advanced technical execution.",
    },
    {
      image: s7,
      title: "Event Automation",
      desc: "Smart technology integration for smooth and efficient event management.",
    },
    {
      image: s8,
      title: "Technical Support",
      desc: "On-site expert support ensuring flawless performance throughout the event.",
    },
  ];
  ...
  return (
    <>
      ...
      border gold-shimmer rounded-xl sm:rounded-2xl 
    ...
    "
      ...
      <section className="bg-[#0B1D3A] py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 relative overflow-hidden">
        {/* Background Glow */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="
        bg-white/5 backdrop-blur-xl border border-[#CFAF4B33] 
      ...
      "
        ...
        "
            >
              ...
              , we use advanced technology to make your events truly stand out.
              Our expert team integrates high-quality sound systems, vibrant
              digital displays, dynamic LED lighting, fog machines, and special
              effects to create an immersive and unforgettable experience. By
              combining these tools seamlessly, we ensure your event looks
              professional, feels exciting, and leaves a lasting impression on
              every guest.
            </motion.p>
          ...
          gap-4 sm:gap-6 mt-6 sm:mt-10 text-left
        "
            >
              {[
                ...
                >
                  <div className="w-2 h-2 gold-shimmer rounded-full mt-2"></div>
      ...
      <section className="bg-[#0B1D3A] py-16 sm:py-20 px-4 sm:px-6 md:px-10 pb-10">
        ...
        <div className="text-center mb-10 sm:mb-14">
          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white">
            Technical{" "}
            <span className="gold-shimmer-text font-medium">Integration</span>
          </h2>

          <p className="text-sm sm:text-base md:text-lg text-gray-300 mt-3">
            Powering events with advanced technology & seamless execution
          </p>
        </div>
              ...
              >
                <div className="relative rounded-xl overflow-hidden shadow-xl group">
                  ...
                  <img
                    ...
                    className="
                w-full 
                h-[250px] sm:h-[300px] md:h-[380px] lg:h-[450px]
            ...
            "
                  >
                    ...
                    <div className="relative z-10">
                      <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800 group-hover:text-[#0B1D3A]">
                        {item.title}
                      </h3>

                      <p className="text-xs sm:text-sm text-gray-600 mt-2 group-hover:text-[#0B1D3A]">
                        {item.desc}
                      </p>
                    </div>
                  </div>
        ...
        <div className="flex justify-center sm:justify-end gap-3 sm:gap-4 mt-6">
          <button
            onClick={prevSlide}
            className="gold-shimmer-btn text-white px-5 sm:px-6 py-2 sm:py-3 rounded-full"
          >
            <ArrowLeft size={18} />
          </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
            {[
              ...
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-xl border border-[#CFAF4B33] rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-left shadow-[0_0_40px_rgba(0,0,0,0.5)] hover:shadow-[0_0_50px_rgba(207,175,75,0.25)] transition duration-300"
              >
                {/* Quote */}
      ...
      <section className="bg-[#071426] py-16 sm:py-20 md:py-24 lg:py-32 px-4 sm:px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <motion.button
            ...
            className="relative overflow-hidden px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full border border-[#CFAF4B] text-white text-sm sm:text-base font-semibold group shadow-[0_0_20px_rgba(207,175,75,0.3)]"
          >
            {/* Shimmer Background */}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-10">
        {[
          ...
          <motion.div
            ...
            className="bg-white/5 backdrop-blur-lg border border-[#CFAF4B33] rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 hover:scale-105 transition duration-300 shadow-[0_0_40px_rgba(0,0,0,0.5)]"
          >
            {/* Number */}

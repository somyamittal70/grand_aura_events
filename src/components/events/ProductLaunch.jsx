...
export default function ProductLaunch() {
  const description = `
At GrandAura, we create impactful product launch events that captivate audiences and elevate your brand presence. From concept to execution, we design experiences that generate excitement, engagement, and lasting impressions.
`;
    ...
    <div className="bg-[#0B1D3A] text-white">
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10">
        ...
        <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-14 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-400 px-2">
            Creating powerful launches that leave a lasting impact
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          {[
            { title: "Brand Reveal Experiences", img: img1 },
            { title: "Creative Launch Concepts", img: img2 },
            { title: "Audience Engagement", img: img3 },
            { title: "Live Demonstrations", img: img4 },
            { title: "Media & Press Coverage", img: img5 },
            { title: "Seamless Execution", img: img6 },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 sm:mb-8 md:mb-10 text-white">
          Let’s Launch Your Product with Impact
        </h2>

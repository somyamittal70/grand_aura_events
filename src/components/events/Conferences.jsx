...
export default function Conferences() {
  const description = `
At GrandAura, we specialize in organizing seamless and impactful conferences tailored to your goals. From venue selection and stage setup to audio-visual support and attendee management, we handle every detail with precision.

Whether you’re hosting a customer-focused user conference or an internal summit, we ensure a professional, engaging, and memorable experience.
`;
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10">
        ...
        <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-gray-400 text-sm sm:text-base md:text-lg px-2">
            Everything you need for a successful and impactful conference
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6 md:gap-10">
          {[
            { title: "End-to-End Planning", img: img1 },
            { title: "Advanced AV Setup", img: img2 },
            { title: "Guest Management", img: img3 },
            { title: "Live Streaming", img: img4 },
            { title: "Venue Coordination", img: img5 },
            { title: "On-site Execution", img: img6 },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10 bg-[#09172E]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-10 text-gray-300 max-w-3xl mx-auto">
          {[
            ...
            "Registration & attendee handling",
            "Speaker coordination",
            "Live streaming & hybrid events",
          ].map((item, i) => (
            <div key={i} className="flex items-start gap-3 sm:gap-4">
              <span className="text-[#CFAF4B] text-sm sm:text-base mt-[2px]">
                ✔
              </span>

...
export default function Accommodation() {
  const description = `
At GrandAura, we provide seamless accommodation and transport solutions to ensure a smooth and comfortable experience for your guests. From luxury stays to efficient travel coordination, we manage every detail with precision and care.
`;
    ...
    <div className="bg-[#0B1D3A] text-white">
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10">
        ...
        <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-14 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-400 px-2">
            Ensuring comfort, convenience, and seamless travel experiences
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          {[
            { title: "Luxury Hotel Bookings", img: img1 },
            { title: "Group Accommodation Planning", img: img2 },
            { title: "Airport Transfers", img: img3 },
            { title: "Transport Coordination", img: img4 },
            { title: "VIP Travel Services", img: img5 },
            { title: "On-time Execution", img: img6 },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10 bg-[#09172E]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8 md:gap-10 text-gray-300 max-w-3xl mx-auto">
          {[
            "Hotel selection & room allocation",
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 text-center">
        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-white mb-6 sm:mb-8 md:mb-10">
          Let’s Make Travel & Stay Effortless
        </h2>

        {/* Button */}
        <Link
          to="/contact"
          className="inline-block border border-[#CFAF4B] px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold relative overflow-hidden group text-sm sm:text-base"
        >
          {/* Text */}
          <span className="relative z-10 group-hover:text-[#0B1D3A] transition">
            Plan Your Travel & Stay
          </span>

...
export default function GalaDinners() {
  const description = `
At GrandAura, we craft luxurious gala dinners that blend elegance, fine dining, and unforgettable entertainment. From sophisticated décor to seamless execution, we create an atmosphere that reflects prestige, celebration, and exclusivity.
`;
    ...
    <div className="bg-[#0B1D3A] text-white">
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10">
        ...
        <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-gray-400 text-sm sm:text-base md:text-lg px-2">
            Elegant evenings designed with sophistication and perfection
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6 md:gap-10">
          {[
            { title: "Luxury Dining Experience", img: img1 },
            { title: "Elegant Decor & Styling", img: img2 },
            { title: "Live Entertainment", img: img3 },
            { title: "Premium Hospitality", img: img4 },
            { title: "Theme-based Concepts", img: img5 },
            { title: "Flawless Execution", img: img6 },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10 bg-[#09172E]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-10 text-gray-300 max-w-3xl mx-auto">
          {[
            "Venue selection & luxury setup",
            "Premium catering & menu planning",
            "Decor & theme design",
      ...
      <section className="py-16 sm:py-20 md:py-24 lg:py-28 px-4 sm:px-6 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 sm:mb-8 md:mb-10 leading-snug">
          Let’s Create a Grand & Elegant Evening
        </h2>

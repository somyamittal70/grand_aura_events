...
export default function Sales() {
  const description = `
At GrandAura, we design impactful sales kick-off events that energize teams, align strategies, and drive performance. From engaging presentations to immersive experiences, we create events that motivate your workforce and set the tone for success.
`;
  ...
  <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-12 md:mb-16">
    ...
    <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-2xl mx-auto">
      Energizing teams and driving performance through impactful events
    </p>
  </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 max-w-7xl mx-auto">
    {[
      {
        title: "Team Motivation & Engagement",
        img: img1,
      },
      {
  ...
  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 sm:mb-8 md:mb-10 text-white">
    Let’s Kickstart Your Sales Success
  </h2>

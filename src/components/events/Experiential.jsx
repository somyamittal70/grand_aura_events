...
=======
import experiential from "../../assets/experiential.jpeg";
import { motion } from "framer-motion";
import { Link } from "react-router-dom";
import Divider from "../home/Divider";
import img1 from "../../assets/exp1.webp";
import img2 from "../../assets/exp2.webp";
import img3 from "../../assets/exp3.webp";
import img4 from "../../assets/exp4.webp";
import img5 from "../../assets/exp5.webp";
import img6 from "../../assets/exp6.webp";
>>>>>>> fe4c9d8 (Updated project)

export default function Experiential() {
  const description = `
At GrandAura, we create immersive experiential events that connect brands with audiences in meaningful ways. From interactive setups to engaging brand activations, we design experiences that leave a lasting impression and elevate your brand presence.
`;
  ...
  return (
    <div className="bg-[#0B1D3A] text-white">
      {/* 🔥 MAIN */}
<<<<<<< HEAD
      <EventPage title="Experiential" img={img} description={description} />
=======
      <EventPage title="Experiential" img={experiential} description={description} />
>>>>>>> fe4c9d8 (Updated project)
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10">
        ...
        <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-2xl mx-auto">
            Creating engaging, immersive and memorable brand experiences
          </p>
        </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10 bg-[#09172E]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 md:gap-8 text-gray-300 max-w-3xl mx-auto">
          {[
            ...
            "On-ground engagement strategies",

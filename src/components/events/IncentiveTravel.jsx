...
import { Link } from "react-router-dom";
import Divider from "../home/Divider";
import img1 from "../../assets/incen1.webp";
import img2 from "../../assets/incen2.webp";
import img3 from "../../assets/incen3.webp";
import img4 from "../../assets/incen4.webp";
import img5 from "../../assets/incen5.webp";
import img6 from "../../assets/incen6.webp";
>>>>>>> fe4c9d8 (Updated project)

export default function IncentiveTravel() {
  const description = `
At GrandAura, we design exclusive incentive travel experiences that reward, motivate, and inspire. From luxury destinations to seamless planning, we create unforgettable journeys that strengthen team spirit and celebrate achievements in style.
`;
  ...
  return (
    <div className="bg-[#0B1D3A] text-white">
      {/* 🔥 MAIN */}
<<<<<<< HEAD
      <EventPage title="Incentive Travel" img={img} description={description} />
=======
      <EventPage title="Incentive Travel" img={travel} description={description} />
>>>>>>> fe4c9d8 (Updated project)
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10">
        ...
        <div className="max-w-7xl mx-auto text-center mb-10 sm:mb-14 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-400 px-2">
            Curated travel experiences designed to reward and inspire
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          {[
            { title: "Luxury Destinations", img: img1 },
            { title: "Customized Itineraries", img: img2 },
            { title: "Team Building Activities", img: img3 },
            { title: "Premium Hospitality", img: img4 },
            { title: "Adventure Experiences", img: img5 },
            { title: "Seamless Coordination", img: img6 },
          ].map((item, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <img
                src={item.img}
                alt={item.title}
                className="w-full h-[220px] sm:h-[260px] md:h-[320px] object-cover transform group-hover:scale-110 transition duration-700"
              />
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-10 bg-[#09172E]">
        ...
        {/* List */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8 md:gap-10 text-gray-300 max-w-3xl mx-auto">
          {[
            "Destination selection & planning",
            "Travel & accommodation management",
            "Luxury experiences & excursions",
            "Group coordination & logistics",
            "On-ground event support",
            "End-to-end travel execution",
          ].map((item, i) => (
            <div
              key={i}
              className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg hover:bg-white/5 transition duration-300"
            >
              {/* Check Icon */}
              <span className="gold-shimmer-text text-base sm:text-lg mt-1">
                ✔
              </span>
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 sm:mb-8 md:mb-10 text-white">
          Let’s Plan an Unforgettable Journey
        </h2>
